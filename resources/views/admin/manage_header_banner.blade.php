...
<x-side_menu/>
  ...
  <div class="card card-primary col-md-10 offset-md-1">
              ...
              <div class="card-header"   style="margin-top:10px">
                <h3 class="card-title">Edit Header Banner </h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
            <?php
            $logo= DB::table('header_banner')->where('id',1)->first();
            ?>
              <form method="post" action="{{route('update-header-banner')}}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <img src="uploads/header/<?php echo $logo->image;?>" class="img-thumbnail">
