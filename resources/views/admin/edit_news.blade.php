                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="row offset-1">
                            ...
                            @foreach ($category as $cat)
                                ...
                                @endphp
                                <div class="col-md-12">
                                    <input type="checkbox" <?php if(in_array($cat->id,$categorydata)){?> checked <?php }?>
                                        name="category[]" class="categorydata" value="{{ $cat->id }}"
                                        onclick="GetSubCateories()"> {{ $cat->title }}
                                    @if ($subcategories->count() > 0)
                                        <div class="row" style="border-left: 4px solid blue; padding: 10px;">
                                            @foreach ($subcategories as $subcategory)
                                                <div class="subcategory_div col-md-3">
                                                    <input {{(in_array($subcategory->id,explode(',',$news['subcategory']))) ? 'checked' : ''}} type="checkbox" name="subcategory[]" class="subcategorydata"
                ...
                <div class="row">
                    <div class="form-group col-md-2">
                        ...
                        <select name="breaking_news" class="form-control">
                            ...
                            <?php
  for($a=2;$a<=30;$a++){?>
                            <option value="<?php echo $a; ?>" <?php if($news['breaking_news']==$a){?> selected <?php } ?>>
                                <?php echo $a; ?> Minutes</option>
                            <?php }?>
