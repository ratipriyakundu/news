    ...
    <div class="row">
        <div class="col-md-9">
            <div class="d-flex justify-content-between p-3">
                ...
                <div>
                    <p class="h6 fw-bold mb-4 text-danger">
                        <span class="d-inline">
                            और पढ़ें
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-7">
                            <img src="img/placeholder.webp" style="width:100%;height:200px;object-fit:cover;">
                        </div>
                        <div class="col-md-5">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-4">
                            <img src="img/placeholder.webp" style="width:100%;height:80px;object-fit:cover;">
                        </div>
                        <div class="col-md-8">
                            <p class="mt-3">
                                लोरेम इप्सम प्रिंटिंग लोरेम इप्सम प्रिंटिंग और टाइपसेटिंग उद्योग का केवल डमी टेक्स्ट है...
                            </p>
                        </div>
                    </div>
                    <hr>
